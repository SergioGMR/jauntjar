...
@push('styles')
    <style>
        ...
        .gm-style button[aria-label="Cerrar"] {
        ...
        .gm-style button[aria-label="Close"] span,
        .gm-style button[aria-label="Cerrar"] span {
        ...
        .gm-style button[aria-label="Close"] span::before,
        .gm-style button[aria-label="Cerrar"] span::before {
            content: '×';
            font-size: 18px;
            font-weight: 600;
            line-height: 1;
        ...
        .gm-style button[aria-label="Close"]:hover span,
        .gm-style button[aria-label="Close"]:focus-visible span,
        .gm-style button[aria-label="Cerrar"]:hover span,
        .gm-style button[aria-label="Cerrar"]:focus-visible span {
